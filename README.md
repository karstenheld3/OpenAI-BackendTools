...
| Open AI Docs                       | [Conversations](https://platform.openai.com/docs/guides/conversation-state) | [Conversation state](https://platform.openai.com/docs/guides/conversation-state?api-mode=responses) | [Response tools](https://platform.openai.com/docs/guides/tools) | [File search](https://platform.openai.com/docs/guides/tools-file-search) / [Retrieval](https://platform.openai.com/docs/guides/retrieval) | [Using PDF files](https://platform.openai.com/docs/guides/pdf-files) |
| Open AI Docs                       | [Assistants](https://platform.openai.com/docs/assistants/overview) | [Agents](https://platform.openai.com/docs/guides/agents)     | [Agent tools](https://platform.openai.com/docs/guides/agents#tools) | [Data retention](https://platform.openai.com/docs/guides/your-data) | [Prompt caching](https://platform.openai.com/docs/guides/prompt-caching) |
| Open AI Docs                       | [Actions](https://platform.openai.com/docs/actions/introduction) | [Function calling](https://platform.openai.com/docs/guides/function-calling) | [Reasoning](https://platform.openai.com/docs/guides/reasoning) | [GPT-5](https://platform.openai.com/docs/guides/latest-model) | [GPT-5.1](https://platform.openai.com/docs/guides/latest-model) |
| Open AI Docs                       | [Evals](https://platform.openai.com/docs/guides/evals)       | [Graders](https://platform.openai.com/docs/guides/graders)   | [Fine-tuning](https://platform.openai.com/docs/guides/fine-tuning) | [Connectors, MCP servers](https://platform.openai.com/docs/guides/tools-connectors-mcp) |                                                              |
...
| Open AI API                        | [Conversations](https://platform.openai.com/docs/api-reference/conversations) | [Evals](https://platform.openai.com/docs/api-reference/evals) | [Graders](https://platform.openai.com/docs/api-reference/graders) | [Search vector store](https://platform.openai.com/docs/api-reference/vector_stores/search) |                                                              |
