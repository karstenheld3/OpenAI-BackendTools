...
| Open AI Docs                    | [Data retention](https://platform.openai.com/docs/guides/your-data) | [Using PDF files](https://platform.openai.com/docs/guides/pdf-files) | [Graders](https://platform.openai.com/docs/guides/graders)   |                                                              |                                                              |
